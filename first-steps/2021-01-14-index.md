...
5. In the message, you will find instructions to confirm your e-mail address. Click on the URL to activate your account. This link is valid for 14 days. The link redirects you to the  [Real-Time Manager page](https://manager.azion.com/).

   

   If you do not receive the email, check your Spam folder. The e-mail contains the following headers:
