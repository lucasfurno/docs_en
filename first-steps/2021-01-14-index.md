...
From the [Real-Time Manager](https://manager.azion.com/) home screen, select **Edge Computing** > **Edge Application** and click **Add Application**. You have to define a name for this application. 
