...
- **AWS Kinesis Data Firehose**:a new  connector available for integration. Check it out here how to configure your Kinesis Data Firehose endpoint to receive data collected via Data Streaming. 
...
**Edege ???** waiting for confirmation
