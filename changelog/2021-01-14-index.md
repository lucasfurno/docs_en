...
- **Drift configuration management**: Edge Orchestrator now grants that every file provisioned on Edge Nodes are the same defined in the Edge Service, restoring if any file is changed manually. 
