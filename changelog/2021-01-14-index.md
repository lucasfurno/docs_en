...
- **Data Streaming** 
  ...
  Elastic and BigQuery connectors are now available for codeless integration, increasing your endpoint configuration possibilities. 
...
- **Data Streaming**
  ...
  A new data source, Edge Functions, is now available in the Data Streaming product. 
