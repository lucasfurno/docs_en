...
- **AWS Kinesis Data Firehose**: a new  connector available for integration. Check it out [here](https://www.azion.com/en/documentation/products/data-streaming/#Settingtheendpoint) how to configure your Kinesis Data Firehose endpoint to receive data collected via Data Streaming. 

**Edge Firewall**

- **Web Application Firewall** has a new feature: *Custom Allowed Rules*, which allows you to select specific Rule IDs, improving the creation and editing of [WAF](https://www.azion.com/en/documentation/products/web-application-firewall/) rules. In addition, the WAF list gained two fileds: *last editor* and *last modified*. Respectively, they display who created or edited a rule and when this occurred.
...
- Origin Redirection: customers can now configure a 302 - redirect to origin. Thus, Follow redirect 302 to Origin enables the client to obtain more stability and control.

## Updates

**Real-Time Events**

-  Real-Time Events now shows the variables `geoloc_city_name` and  `asn` the Edge Applications [data source](https://www.azion.com/en/documentation/products/real-time-events/#DataSources). 
