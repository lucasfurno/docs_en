...
- **Drift configuration management**: Edge Orchestrator now allows each configuration file in an edge node to be the same as the one defined in the Edge Service, restoring if any file is changed manually.
