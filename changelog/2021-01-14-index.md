...
- **Data Streaming TLS support for Apache Kafka endpoint:** Data Streaming enables you to send encrypted data to Apache Kafka endpoints using Transport Layer Security (TLS), the successor to Secure Sockets Layer (SSL). Learn more about this feature [here](https://www.azion.com/en/documentation/products/data-streaming/#ApacheKafka).
