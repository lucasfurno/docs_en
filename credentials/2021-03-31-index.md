...
> Credentials are used solely for the Edge Orchestrator. To generate tokens for APIs, head to the [API documentation](https://www.azion.com/en/documentation/products/api/v3/authentication/).
