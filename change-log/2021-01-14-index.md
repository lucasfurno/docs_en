...
namespace: documentation_change_log
permalink: "/documentation/products/change-log/"
permalink_en: "/documentation/products/change-log/"
permalink_pt-br: "/documentacao/produtos/change-log/"
...
- **Edge Firewall**
  ...
  **New!** [API for Edge Firewall - Edge Functions Instances](https://www.azion.com/pt-br/documentacao/produtos/api/v3/edge-firewall/function-instances/): with the API of Edge Firewall –Edge Functions Instances–, you can check, remove or update existing settings, besides creating new ones. 
...
* **Edge Caching:** fixed Cache Settings list .

* **Edge Firewall API:** Real-Time Metrics issues resolved.

* **Data Streaming:** you can now edit/add Data Streamings with Google BigQuery endpoint type.
...
* **API V3 - Real-Time Metrics:** search for LastHour fixed.
* **Edge Application:** problem while cloning an Edge Application with Json Args resolved.
* **Real-Time Metrics:** problem while selecting a setting in Real-Time Metric fixed.
...
- Situations of cache on Set-Cookie fixed;
...
* **API V3 - Real-Time Metrics** 
  ...
  Available! Learn more about the new [**API V3 of the Real-Time Metrics**](https://www.azion.com/en/documentation/products/api/v3/real-time-metrics/).
...
- **Edge Firewall**: correction to prevent the creation of whitelists whose Path contains special characters.
- **Edge Orchestrator**
...
- **Real-Time Events:** Real-Time Events search tool fixed to allow filtering by date.
...
* **Real-Time Metrics:** link update from "Content Delivery" to "Real-Time Metrics".
