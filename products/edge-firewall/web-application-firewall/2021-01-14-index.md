...
### WAF self-calibration {#WAF-self-calibration}

After enabling threat blocking in the Rule Set, you can customize which rules will be allowed through WAF self-calibration. To customize the rules for your application, proceed as follows:

1. Go to the **Edge Libraries** > **WAF Rules** menu;
2. Click on the **WAF Rule Set** you want to customize; 
3. Go to the **Tuning** tab and fill in the **Domain(s)**, **Time Range** and **Network** fields; 
4. Click the **Apply filter** button to view the **Possible Attacks List**; 
5. Select the checkbox for the rules you want to allow and click **Allow Rules**;
6. A confirmation window will open, enter information related to the rule you want to allow and click **Allow Rules**. Added rules can be seen, edited or deleted in the **Allowed Rules** tab.
