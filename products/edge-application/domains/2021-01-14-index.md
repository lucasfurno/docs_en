...
To delete Domains, do as follows:

1. Access [Real-Time Manager](https://manager.azion.com/) and select **Domains** in the Edge Computing menu.
2. Locate the Domain that you need to remove and click on **Trash icon** on the right-side
3. Confirm the deletion typing **delete** and click **Delete**
