...
[Edit on GitHub <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#F3652B"><path d="M4.81.71H.672v11.43H12.1V8.001" stroke-width=".8"/><path d="M6.87.786h5.155V5.94M6.31 6.5L12.026.786"/></g></svg>](https://github.com/aziontech/docs_en/edit/master/products/intelligent-dns/2021-01-14-index.md)
...
4. To create a new record, click the **Add Record** button and fill in the following fields: Name, Type, Value, TTL (seconds) and Policy. See the details below.
   ...
   This description is the domain that you want to create. For example: “*help*”, in “[*help.azion.com*](https://help.azion.com/)”, or then “*manager*” in “[*manager.azion.com*](https://manager.azion.com/)”
