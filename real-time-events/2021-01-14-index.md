...
| $edge_functions_solution_id         | Unique Azion solution identifier.                        |
| $edge_functions_initiator_type_list | Function type: 1 (Edge Applications); 2 (Edge Firewall). |
| $edge_functions_language            | Language used in the function (“lua“ or “javascript“)    |
| $timestamp                          | Request date and time.                                   |
