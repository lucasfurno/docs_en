...
3.  Click the **Add certificate** button to add a **Digital Certificate** including your Certificate information;
4.  Access the menu **Edge Computing** and select **My Domains**;
5.  In the field **Digital Certificate**, select **Digital Certificate** created in **step 2**;
6.  Click the **Save** button to save your settings and you will be using your own Certificate.

> **Note:** you can provide the *complete certificate chain* for your domains in the **Certificate** field. This avoids possible issues in the case of some older operating systems.
