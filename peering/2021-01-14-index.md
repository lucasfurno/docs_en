...
The technical requirements that apply to peering with Azion Peers must:
...
* ensure a high quality of experience for the end user with the interconnections that must occur at mutual locations, with a minimum of 2x 10G SFP+ Ethernet interfaces, and the interface capacity upgrades that must occur in a timely manner.
