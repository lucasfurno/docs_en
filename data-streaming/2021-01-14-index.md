...
In case you've contracted [Edge Functions](https://www.azion.com/pt-br/documentacao/produtos/edge-functions/), you may use the following available variables for the defined data source.
...
| $log_level        | Level of log generator (ERROR, WARN, INFO, DEBUG, TRACE). |
| $log_message      | Message used in the function log.                         |
