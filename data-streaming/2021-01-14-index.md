...
In addition, Data Streaming follows the good practices of information traffic by using ASCII encoding to avoid parser issues, that is, problems in data interpretation. 
  ...
  >
  >    *[Apache Kafka](#ApacheKafka) - [AWS Kinesis Data Firehose](#AWS) - [Data Dog](#DataDog) - [Elasticsearch](#Elasticsearch) -  [Google BigQuery](#Google) - [Simple Storage Service (S3)](#S3) - [Splunk](#Splunk) - [Standard HTTP/HTTPS POST](#StandardHTTPHTTPSPOST)*
  >
...
- **API URI:** (*requiered*) refers to the URI that will receive the collected data from Data Streaming.
