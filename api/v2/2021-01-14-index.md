...
layout: page-api-md
title:   API  v2
description:  The Azion API is a RESTful API, based on HTTPS requests, that allows you to integrate your systems with our platform, simply, quickly and securely.
meta_tags: apiv2, edge computing
...
[Edit on GitHub <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="#F3652B"><path d="M4.81.71H.672v11.43H12.1V8.001" stroke-width=".8"/><path d="M6.87.786h5.155V5.94M6.31 6.5L12.026.786"/></g></svg>](https://github.com/aziontech/docs_en/edit/master/api/v2/2021-01-14-index.md)
...
### X-ratelimit-limit by produto

The *X-ratelimit limit* varies by product as follows:

- ​	**Real-Time Analytics:** 20 requests per minute.
