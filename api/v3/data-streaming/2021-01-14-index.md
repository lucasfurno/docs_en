...
Allows the user to register a new data streaming.
...
During the process of creating or updating a data streaming, different endpoints are availabe to use. Next, check the endpoints that may be used and the following proporties that must be filled. 
...
Required permissioj: ***Edit Data Streaming***
