...
| Datadog                     | datadog              | url<br />api_key                                             | ``"endpoint": {        "endpoint_type": "datadog",        "url": "https://http-sintake.logs.datadoghq.com/v1/input",        "api_key": "MYAPIKEY"      }`` |
| IBM QRadar                     | qradar              | url                                             | ``endpoint": {        "endpoint_type": "standard"      }`` |
