...
> 1. [Retrieving a list of Edge Functions](#retrieving)
...
## 1. Retrieving a list of Edge Functions AINDA NÃO {#retrieving}

It returns a list of Edge Functions.
...
## 6.Updating the fields of an Edge Function AINDA NÃO {#updating}

It updates one or more fields of an Edge Function, retaining the value of those fields not included.
