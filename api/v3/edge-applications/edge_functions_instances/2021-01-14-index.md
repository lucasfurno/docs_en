...
permalink_pt-br: "/documentacao/produtos/api/v3/edge-application/edge-functions-instances/"
...
> 1. [Retrieving a list of Edge Functions Instances](#looking-up-a-list-of-functions-instances)
> 2. [Retrieving details of Edge Functions Instances](#looking-up-details-of-functions-instances)
...
| --- | --- | --- | --- |
| Authorization (mandatory) | Authentication through the Token, previously created through the endpoint of Token Creation | header | string |
